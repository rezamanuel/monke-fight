...
using UnityEngine;
    ...
    public class SceneBootstrapper
    {
        ...
        const string k_LoadBootstrapSceneOnPlay = "Monke/Load Bootstrap Scene On Play";
        const string k_DoNotLoadBootstrapSceneOnPlay = "Monke/Don't Load Bootstrap Scene On Play";
